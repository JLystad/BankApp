...
const Profile = () => {
  ...
  <h5 className='pro-file'> <span className="color"> Welcome </span>:{data.Name}</h5>
  <h5 className='pro-file'>   <span className="color">D-O-B</span>:{data.Dob}</h5>
  <h5 className='pro-file'>   <span className="color">Email</span>:{data.Email}</h5>
  <h5 className='pro-file'>   <span className="color">Phone Number</span>:{data.PhoneNumber}</h5>
